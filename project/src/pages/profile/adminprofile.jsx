      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="flex items-center mb-6">
            ...
            <div className="ml-6">
              <h2 className="text-2xl font-bold">Admin John Doe</h2>
              <p className="text-gray-500">Admin ID: A12345</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="font-medium">john.doe@admin.com</p>
              </div>
              <motion.button
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-medium text-primary">350</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <motion.div
                  initial={{ width: 0 }}
